...
if exists(select 1 from sys.sysforeignkey where role='FK_ADMIN_USUARIOS__FERRETER') then
    alter table ADMIN
       delete foreign key FK_ADMIN_USUARIOS__FERRETER
end if;

if exists(select 1 from sys.sysforeignkey where role='FK_COLABORA_USUARIOS__FERRETER') then
    alter table COLABORADOR
       delete foreign key FK_COLABORA_USUARIOS__FERRETER
end if;

if exists(select 1 from sys.sysforeignkey where role='FK_DEVOLUCI_RELATIONS_PRODUCTO') then
    alter table DEVOLUCION
       delete foreign key FK_DEVOLUCI_RELATIONS_PRODUCTO
end if;

if exists(select 1 from sys.sysforeignkey where role='FK_DEVOLUCI_RELATIONS_FACTURA') then
    alter table DEVOLUCION
       delete foreign key FK_DEVOLUCI_RELATIONS_FACTURA
end if;

if exists(select 1 from sys.sysforeignkey where role='FK_FACTURA_RELATIONS_PROVEEDO') then
    alter table FACTURA
       delete foreign key FK_FACTURA_RELATIONS_PROVEEDO
end if;

if exists(select 1 from sys.sysforeignkey where role='FK_PRECIO_RELATIONS_PRODUCTO') then
    alter table PRECIO
       delete foreign key FK_PRECIO_RELATIONS_PRODUCTO
end if;

if exists(select 1 from sys.sysforeignkey where role='FK_PRECIO_RELATIONS_PROVEEDO') then
    alter table PRECIO
       delete foreign key FK_PRECIO_RELATIONS_PROVEEDO
end if;

if exists(select 1 from sys.sysforeignkey where role='FK_PRODUCTO_RELATIONS_FERRETER') then
    alter table PRODUCTO
       delete foreign key FK_PRODUCTO_RELATIONS_FERRETER
end if;

if exists(select 1 from sys.sysforeignkey where role='FK_PROUCTO__RELATIONS_FACTURA') then
    alter table PROUCTO_FACTURA
       delete foreign key FK_PROUCTO__RELATIONS_FACTURA
end if;

if exists(select 1 from sys.sysforeignkey where role='FK_PROUCTO__RELATIONS_PRODUCTO') then
    alter table PROUCTO_FACTURA
       delete foreign key FK_PROUCTO__RELATIONS_PRODUCTO
end if;

drop index if exists ADMIN.USUARIOS_FERRETERIA2_FK;

drop index if exists ADMIN.ADMIN_PK;

drop table if exists ADMIN;

drop index if exists COLABORADOR.USUARIOS_FERRETERIA_FK;

drop index if exists COLABORADOR.COLABORADOR_PK;

drop table if exists COLABORADOR;

drop index if exists DEVOLUCION.RELATIONSHIP_4_FK;

drop index if exists DEVOLUCION.RELATIONSHIP_3_FK;

drop index if exists DEVOLUCION.DEVOLUCION_PK;

drop table if exists DEVOLUCION;

drop index if exists FACTURA.RELATIONSHIP_10_FK;

drop index if exists FACTURA.FACTURA_PK;

drop table if exists FACTURA;

drop index if exists FERRETERIA.FERRETERIA_PK;

drop table if exists FERRETERIA;

drop index if exists PRECIO.RELATIONSHIP_7_FK;

drop index if exists PRECIO.RELATIONSHIP_6_FK;

drop index if exists PRECIO.PRECIO_PK;

drop table if exists PRECIO;

drop index if exists PRODUCTO.RELATIONSHIP_8_FK;

drop index if exists PRODUCTO.PRODUCTO_PK;

drop table if exists PRODUCTO;

drop index if exists PROUCTO_FACTURA.RELATIONSHIP_12_FK;

drop index if exists PROUCTO_FACTURA.RELATIONSHIP_11_FK;

drop index if exists PROUCTO_FACTURA.PROUCTO_FACTURA_PK;

drop table if exists PROUCTO_FACTURA;
